  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      if (err.code === "auth/email-already-in-use") {
        setError("এই ইমেইল আগে থেকেই আছে!");
      } else {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 p-4">
      <div className="bg-white/90 backdrop-blur-xl w-full max-w-md rounded-3xl shadow-2xl overflow-hidden border-2 border-white/50">
        ...
        <div className="p-8">
          <h2 className="text-2xl font-bold text-gray-800 text-center mb-6">নতুন অ্যাকাউন্ট ✨</h2>
          ...
          <div className="space-y-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl border-2 border-gray-200 focus:border-indigo-500 outline-none transition-all text-gray-700 font-medium"
                value={name}
          ...
          >
            <LogIn size={22} />
            {loading ? "রেজিস্ট্রেশন হচ্ছে..." : "Sign Up"}
          </button>
          ...
          <div className="mt-6">
            ...
            <button
              ...
              disabled={loading}
              className="w-full mt-6 flex justify-center items-center gap-2 py-2.5 border-2 border-gray-200 rounded-xl hover:bg-gray-50 transition-colors font-semibold text-gray-700 disabled:opacity-60"
            >
          ...
          <p className="text-center mt-6 text-gray-600 font-medium">
            আগে থেকে অ্যাকাউন্ট আছে? <a href="/login" className="text-indigo-500 hover:text-indigo-600 font-bold">Sign In</a>
          </p>
        </div>
      </div>
    </div>
